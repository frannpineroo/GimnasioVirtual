    ...
    createFallbackSidebar() {
        ...
        sidebar.innerHTML = `
            ...
            <div class="menu-items">
                <a href="./index.html" class="menu-item ${this.currentPage === 'inicio' ? 'active' : ''}" id="menu-inicio">
                    <i class="fas fa-home"></i><span>Inicio</span>
                </a>
                <a href="clientes.html" class="menu-item ${this.currentPage === 'clientes' ? 'active' : ''}" id="menu-clientes">
                    <i class="fas fa-users"></i><span>Clientes</span>
                </a>
                <a href="ejercicios.html" class="menu-item ${this.currentPage === 'ejercicios' ? 'active' : ''}" id="menu-ejercicios">
                    <i class="fas fa-dumbbell"></i><span>Ejercicios</span>
                </a>
                <a href="rutinas.html" class="menu-item ${this.currentPage === 'rutinas' ? 'active' : ''}" id="menu-rutinas">
